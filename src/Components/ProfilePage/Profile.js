...
export default class Profile extends React.Component {
    ...
    render(){
        ...
        const {username, email, gender, age, location, occupation, interests} = this.state;//.profile;
        return(
                ...
                <ScrollView showVerticalScrollIndicator={false}>
                    ...
                    <View style={{alignSelf:"center"}}>
                        ...
                        <View style={styles.profileImage}>
                            <Thumbnail source={{uri:"https://cdn4.iconfinder.com/data/icons/political-elections/50/46-512.png"}}
